...
export default function PillButton({ label, icon: Icon = Plus, suffix, className = "", ...rest }: PillButtonProps) {
  return (
    <a
      {...rest}
      className={`group flex items-center gap-3 border border-[#101010]/25 rounded-full pl-1.5 pr-6 py-1.5 [font-size:var(--font-size-body)] text-[#101010] hover:bg-[#101010]/05 transition-colors duration-200 ${className}`}
    >
